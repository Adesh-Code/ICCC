...
exports.makeTreeItemStyles = void 0;
var makeTreeItemStyles = exports.makeTreeItemStyles = function makeTreeItemStyles(_ref) {
    ...
    MuiTreeItem: {
      styleOverrides: {
        ...
        content: Object.assign(Object.assign({
          ...
          "&.Mui-focused": Object.assign(Object.assign({}, tokens.transitions["state-activate"]), {
        ...
        group: {
          ...
          position: "relative",
          padding: "0",
          "&:before": Object.assign(Object.assign({
            content: '""',
            position: "absolute",
            height: "100%",
            width: "100%",
            ...
            background: "linear-gradient(0deg, ".concat(tokens.colors["fade-gradient-opaque"], " 0%, ").concat(tokens.colors["fade-gradient-transparent"], " 100%)")
          }),
