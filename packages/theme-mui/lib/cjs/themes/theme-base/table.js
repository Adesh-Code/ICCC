...
exports.makeTableStyles = void 0;
var makeTableStyles = exports.makeTableStyles = function makeTableStyles(_ref) {
  ...
  return {
        ...
        root: {
          ...
          "&.DhigTable--loud": {
            "& tr.DhigTableRow--enableInteractions": {
              position: "relative",
              borderBottom: "".concat(primitives.borderWidths.medium, " solid ").concat(tokens.colors["row-divider"]),
              "&:hover": {
              ...
              "&:active": {
                ...
                backgroundAttachment: "fixed",
                boxShadow: "".concat(tokens.effects["halo-pressed"], " inset")
              },
              ...
              '& td.MuiTableCell-sizeSmall:not([class*="MuiTableCell-paddingCheckbox"])': {
                padding: "10px ".concat(primitives.spacings["4"])
              }
            },
            ...
            "& tr.Mui-selected.DhigTableRow--highlighted.DhigTableRow--enableInteractions": {
              "&:hover": {
                backgroundAttachment: "fixed",
                background: tokens.gradients["row-highlighted-selected-hover-loud"],
                borderRadius: primitives.borderRadii.medium,
                boxShadow: tokens.effects["hover-halo-inwards"]
              },
              "&:active": {
                backgroundAttachment: "fixed",
                background: tokens.gradients["row-highlighted-selected-pressed-loud"],
                borderRadius: primitives.borderRadii.medium,
                boxShadow: "".concat(tokens.effects["halo-pressed"], " inset")
              }
            }
          ...
          "&.DhigTable--bordered": {
            ...
            "& tbody tr td:last-of-type": {
              padding: "".concat(primitives.spacings[4], " ").concat(primitives.spacings[3], " ").concat(primitives.spacings[4], " 0"),
      ...
      styleOverrides: {
        root: {
          ...
          "&.Mui-selected.DhigTableRow--highlighted.DhigTableRow--enableInteractions": {
            ...
            "&:active": {
              backgroundColor: tokens.colors["row-highlighted-selected-pressed"]
            }
          },
          ...
          "&.DhigTableRow--activated.Mui-highlighted": {
            backgroundAttachment: "fixed",
            background: tokens.gradients["row-highlighted-activated-loud-reverse"]
          },
          "&.DhigTableRow--activated.Mui-selected": {
          ...
          "&.DhigTableRow--activated.Mui-selected.DhigTableRow--highlighted": {
            background: tokens.gradients["row-highlighted-selected-activated-loud-reverse"],
            backgroundAttachment: "fixed"
          }
        },
        head: {
    ...
    MuiTableCell: {
      ...
      styleOverrides: {
        root: {
          ...
          '&[class*="MuiTableCell-isEditing"]': {
            ...
            "& [class*='MuiInputBase-root'][class*='MuiOutlinedInput-root']": {
              ...
              "& input[class*='MuiOutlinedInput']": {
                ...
                padding: primitives.spacings["4"],
                "&:focus, &:focus-visible": {
                  boxShadow: "inset 0px 0px 0px 2px ".concat(primitives.colors.accent.iris),
                  outline: "none"
                }
              },
              "& input:active": {
              ...
              "&.Mui-error": {
                ...
                boxShadow: tokens.effects["field-error"],
                "& input:focus-visible": {
                  boxShadow: "inset 0px 0px 0px 2px ".concat(primitives.colors.accent.clay)
                }
              },
              "&.Mui-disabled": {
                borderColor: "transparent"
          ...
          "&:focus-visible": {
            boxShadow: "0px 0px 0px 1px inset ".concat(primitives.colors.accent.iris),
            outline: "none"
          }
        },
        paddingCheckbox: {
          ...
          '& label[class*="MuiFormControlLabel-root"]': {
            ...
            '& [class*="MuiCheckbox-root"] [class*="MuiSvgIcon-root"]': {
              margin: "".concat(primitives.spacings["2"], " ").concat(primitives.spacings["4"])
            },
    ...
    MuiTableHead: {
      styleOverrides: {
        root: {
          "& tr": {
            borderBottom: "".concat(primitives.borderWidths.medium, " solid ").concat(tokens.colors["divider-1"]),
            "&:hover": {
              background: primitives.colors.detail.transparent
            },
            '& th.DhigTableHead--cell[class*="MuiTableCell-sizeSmall"]': {
              padding: "".concat(primitives.spacings[3], " ").concat(primitives.spacings[4])
            },
            ...
            "& th.DhigTableHead--cell": {
              padding: "18px ".concat(primitives.spacings["4"]),
              '& [class*="MuiTableSortLabel-root"]': {
                cursor: "default",
                "& svg[class*='MuiSvgIcon-root']": {
    ...
    MuiTableSortLabel: {
      styleOverrides: {
        root: Object.assign(Object.assign({}, tokens.typography["headline-smaller"]), {
          color: tokens.colors["ink-on-background"],
          pointerEvents: "none",
          "&:hover, :focus": {
            color: tokens.colors["ink-on-background"]
