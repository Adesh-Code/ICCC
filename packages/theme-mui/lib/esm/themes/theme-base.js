 ...
 */
export const getThemeBase = ({ paletteMode = "light", themeData: { primitives, tokens }, }) => {
    ...
    const breakpointValues = Object.entries(tokens.grid).reduce((acc, [key, value]) => {
        acc.keys.push(key);
        acc.values[key] = parseInt(value.breakpoint, 10);
        return acc;
    }, { keys: [], values: {} });
    const { breakpoints } = createTheme({ breakpoints: breakpointValues });
    const transitionValues = Object.entries(tokens.transitions).reduce((acc, [key, value]) => {
    ...
    return {
        ...
        typography: Object.assign({ fontFamily: primitives.fontFamilies.default, fontWeightLight: primitives.fontWeights.default, fontWeightRegular: primitives.fontWeights.default, fontWeightMedium: primitives.fontWeights.emphasized, fontWeightBold: primitives.fontWeights.display, body1: tokens.typography["body-copy-medium"] }, tokens.typography),
        spacing: Object.entries(primitives.spacings).map(([_, value]) => value),
        transitions: Object.assign({}, transitionValues),
        zIndex: {},
        primitives,
        tokens,
        components: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, makeAccordionStyles({ primitives, tokens })), makeAlertStyles({ primitives, tokens })), makeAutocompleteStyles({ primitives, tokens })), makeBadgeStyles({ primitives, tokens })), makeButtonGroupStyles({ primitives, tokens })), makeButtonStyles({ primitives, tokens })), makeCardStyles({ primitives, tokens })), makeCheckboxStyles({ primitives, tokens })), makeChipStyles({ primitives, tokens })), makeCircularProgressStyles({ primitives, tokens })), makeContainerStyles({ primitives })), makeDatePickerStyles({ primitives, tokens })), makeDialogStyles({
            breakpoints,
            paletteMode,
            primitives,
            tokens
        })), makeDividerStyles({ tokens })), makeFilledInputStyles({ primitives, tokens })), makeFormControlLabelStyles({ primitives, tokens })), makeFormControlStyles({ primitives, tokens })), makeFormGroupStyles({ primitives })), makeFormHelperTextStyles({ primitives, tokens })), makeFormLabelStyles({ tokens })), makeGridStyles({ breakpoints, primitives, tokens })), makeIconButtonStyles({ primitives, tokens })), makeInputLabelStyles({ primitives, tokens })), makeInputStyles({ primitives, tokens })), makeLinearProgressStyles({ primitives, tokens })), makeLinkStyles({ tokens })), makeListSubheaderStyles({ primitives, tokens })), makeMenuItemStyles({ primitives, tokens })), makeOutlinedInputStyles({ primitives, tokens })), makePaginationStyles({ primitives, tokens })), makePopoverStyles({ primitives, tokens })), makePopperStyles({ primitives, tokens })), makeRadioStyles({ primitives, tokens })), makeSelectStyles({ primitives, tokens })), makeSkeletonStyles({ tokens })), makeSnackbarStyles({ primitives, tokens })), makeStepperStyles({ primitives, tokens })), makeSvgIconStyles({ primitives, tokens })), makeTableStyles({ primitives, tokens })), makeTabsStyles({ primitives, tokens })), makeTextFieldStyles({ primitives, tokens })), makeToggleButtonGroupStyles({ primitives, tokens })), makeToggleButtonStyles({ primitives, tokens })), makeToolbarStyles({ primitives, tokens })), makeTooltipStyles({ primitives, tokens })), makeTreeItemStyles({ primitives, tokens })), makeTreeViewStyles({ primitives, tokens })), makeTypographyStyles({ tokens }))
    };
};
