export const makeToolbarStyles = ({ primitives, tokens }) => ({
    MuiToolbar: {
        styleOverrides: {
            root: Object.assign(Object.assign({ boxShadow: tokens.effects["elevation-0-dropdown"] }, tokens.typography["short-copy-medium"]), { backgroundColor: tokens.colors["fill-primary"], borderRadius: primitives.borderRadii.large, color: tokens.colors["ink-on-fill-primary"], padding: `${primitives.spacings["2"]} ${primitives.spacings["4"]}`, boxSizing: "border-box", justifyContent: "space-between", minHeight: `calc(${primitives.spacings["8"]} + ${primitives.spacings["1"]})`, '& [class*="MuiIconButton-root"]': {
