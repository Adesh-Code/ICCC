...
export const makeAccordionStyles = ({ primitives, tokens }) => {
    ...
    return {
        ...
        MuiAccordionSummary: {
            defaultProps: {
                expandIcon: (React.createElement(SvgIcon, null,
                    React.createElement(CaretDownSmallIcon, null)))
            },
            styleOverrides: {
                root: Object.assign(Object.assign({ minHeight: primitives.spacings["0"], backgroundColor: "initial" }, tokens.transitions["state-blur"]), { zIndex: 1, "&::before, &::after": Object.assign(Object.assign({ content: "''", position: "absolute", top: 0, right: 0, bottom: 0, left: 0, zIndex: "-1", opacity: 0 }, tokens.transitions["state-blur"]), { borderRadius }), "&::before": Object.assign({ background: "linear-gradient(270deg, rgba(128, 128, 255, 0.2) 0%, rgba(128, 128, 255, 0) 100%)" }, tokens.transitions["state-activate"]), "&::after": Object.assign({ background: "linear-gradient(270deg, rgba(43, 194, 117, 0.15) 0%, rgba(43, 194, 117, 0) 100%)" }, tokens.transitions["state-activate"]), "&.Mui-expanded": {
                        backgroundColor: "initial",
                        minHeight: primitives.spacings["0"]
                    }, "&:hover:not(:active)::before": {
                        opacity: 1
                    }, "&:focus": Object.assign({ boxShadow: tokens.effects["focus-ring-thin"] }, tokens.transitions["state-activate"]), "&:focus:not(:focus-visible)": {
                        boxShadow: "none"
                    }, "&:focus-visible": Object.assign({ boxShadow: tokens.effects["focus-ring-thin"] }, tokens.transitions["state-activate"]), "&:active::after": {
                        opacity: 1
