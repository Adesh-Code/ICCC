export const makeToggleButtonStyles = ({ primitives, tokens }) => ({
    MuiToggleButton: {
        styleOverrides: {
            root: Object.assign(Object.assign({}, tokens.typography["body-copy-small"]), { color: tokens.colors["ink-on-background-60"], fontWeight: primitives.fontWeights.stout, padding: `4.5px ${primitives.spacings["4"]}`, border: "none", boxSizing: "border-box", "&:hover": {
