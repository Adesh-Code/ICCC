export const makeInputStyles = ({ primitives, tokens }) => ({
    MuiInput: {
        styleOverrides: {
            root: {
            ...
            underline: {
                '&[class*="MuiInputBase-root"]': Object.assign(Object.assign({ boxShadow: tokens.effects["field-default"], color: tokens.colors["ink-on-background"] }, tokens.transitions["state-activate"]), { marginTop: primitives.spacings["0"], padding: primitives.spacings["0"], "&:before": Object.assign({ height: "100%" }, tokens.transitions["state-activate"]), "&:after": {
                        ...
                        pointerEvents: "none"
                    }, "&:hover": Object.assign(Object.assign({ boxShadow: tokens.effects["field-default"] }, tokens.transitions["state-blur"]), { '&[class*="MuiFilledInput-underline"]': {
                            boxShadow: "none"
                    ...
                    }, '& [class*="MuiInputBase-input"]': Object.assign(Object.assign({ padding: `${primitives.spacings["2"]} ${primitives.spacings["4"]} ${primitives.spacings["2"]} ${primitives.spacings["3"]}`, color: tokens.colors["ink-on-background"], height: primitives.spacings["6"] }, tokens.typography["input-value"]), { '&[class*="MuiInputBase-inputMultiline"]': {
