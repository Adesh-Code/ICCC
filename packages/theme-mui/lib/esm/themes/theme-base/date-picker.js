...
// @ts-ignore
import CalendarIcon from "@iccc/icon/lib/build/icons/calendar";
// @ts-ignore
import CaretDown from "@iccc/icon/lib/build/icons/caret-down";
// @ts-ignore
import CaretLeft from "@iccc/icon/lib/build/icons/caret-left";
// @ts-ignore
import CaretRight from "@iccc/icon/lib/build/icons/caret-right";
export const makeDatePickerStyles = ({ primitives, tokens }) => ({
    MuiDatePicker: {
        defaultProps: {
    ...
    MuiDayCalendar: {
        styleOverrides: {
            ...
            weekContainer: {
                padding: `0 ${primitives.spacings["6"]}`,
                margin: `${primitives.spacings["1"]} 0`,
                "&:last-of-type": {
                    marginBottom: primitives.spacings["0"],
                    paddingBottom: primitives.spacings["6"]
                }
            },
            weekDayLabel: Object.assign({ color: tokens.colors["ink-on-background-60"], margin: `${primitives.spacings["1"]} 2px 0px 0px` }, tokens.typography["short-copy-medium"]),
            slideTransition: {
                overflowX: "unset",
                minHeight: "unset"
            }
    ...
    MuiPickersDay: {
        styleOverrides: {
            root: Object.assign(Object.assign({ color: tokens.colors["ink-on-background"] }, tokens.typography["short-copy-medium"]), { margin: "2px", marginLeft: `${primitives.spacings["0"]}`, "&.Mui-selected": {
        ...
        styleOverrides: {
            root: {
                ...
                "& [class*='MuiPickersLayout-toolbar']": {
                    ...
                    padding: `${primitives.spacings["6"]} ${primitives.spacings["6"]} ${primitives.spacings["2"]} ${primitives.spacings["6"]}`
                },
                "& [class*='MuiPickersLayout-actionBar']": {
                    padding: `${primitives.spacings["0"]} ${primitives.spacings["6"]} ${primitives.spacings["6"]}`,
                    "& [class*='MuiButtonBase-root']:first-of-type": Object.assign(Object.assign({}, tokens.button["outlined"]["defaultSize"].default), { "&:hover": Object.assign({}, tokens.button["outlined"]["defaultSize"].hover), "&:focus": Object.assign({}, tokens.button["outlined"]["defaultSize"].focus), "&:focus:active": Object.assign({}, tokens.button["outlined"]["defaultSize"].pressed), "&:active": Object.assign({}, tokens.button["outlined"]["defaultSize"].pressed) })
                },
                margin: "2px"
            }
        }
