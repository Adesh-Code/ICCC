...
export const makeDatePickerStyles = ({
  primitives,
  tokens
}: ThemeData) => ({
  MuiDatePicker: {
  ...
  MuiDayCalendar: {
    styleOverrides: {
      ...
      weekDayLabel: {
        color: tokens.colors["ink-on-background-60"],
        margin: `${primitives.spacings["1"]} 2px 0px 0px`,
    ...
    styleOverrides: {
      root: {
        ...
        "& [class*='MuiPickersLayout-actionBar']": {
          ...
          "& [class*='MuiButtonBase-root']:first-of-type": {
            ...tokens.button["outlined"]["defaultSize"].default,
            "&:hover": {
              ...tokens.button["outlined"]["defaultSize"].hover
            },
            "&:focus": {
