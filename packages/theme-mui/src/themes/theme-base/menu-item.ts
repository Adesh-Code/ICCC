...
export const makeMenuItemStyles = ({
  primitives,
  tokens
}: ThemeData) => ({
  MuiMenuItem: {
    styleOverrides: {
      root: {
        boxShadow: `0px 0px 0px 2px ${primitives.colors.detail.transparent}, 0px 0px 0px 1px ${primitives.colors.detail.transparent}`,
        ...
        padding: `${primitives.spacings["2"]} ${primitives.spacings["5"]}`,
        border: `2px solid ${primitives.colors.detail.transparent}`,
        ...tokens.transitions["state-blur"],
