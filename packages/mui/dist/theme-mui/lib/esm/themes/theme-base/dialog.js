...
export const makeDialogStyles = ({ breakpoints, paletteMode, primitives, tokens }) => {
    ...
    const paperMargin = (breakpoint, axis) => parseInt(closeButtonDimensions[breakpoint].iconSize, 10) +
    ...
    return {
        MuiBackdrop: {
            defaultProps: {
                TransitionComponent: React.forwardRef(function Transition(props, ref) {
                    return (React.createElement(Fade, Object.assign({ ref: ref }, props, { easing: primitives.transitions.easing.smooth, timeout: parseFloat(primitives.transitions.duration["3"]) })));
                })
            },
            styleOverrides: {
                root: {
        ...
        MuiDialog: {
            defaultProps: {
                TransitionComponent: React.forwardRef(function Transitions(props, ref) {
                    return (React.createElement(Slide, Object.assign({ ref: ref }, props, { easing: primitives.transitions.easing["slow-down"], timeout: parseFloat(primitives.transitions.duration["2"]), onEntering: (node) => {
                        ...
                        React.createElement("div", null,
                            React.createElement(Fade, Object.assign({ ref: ref }, props, { easing: primitives.transitions.easing["slow-down"], timeout: parseFloat(primitives.transitions.duration["2"]), style: {
            ...
            styleOverrides: {
                ...
                paper: {
                    ...
                    "& .DhigModal--closeButton--outside": Object.assign(Object.assign({}, closeButtonStyles), { position: "fixed", "& [class*='MuiSvgIcon-root'] svg": {
                            color: tokens.colors["ink-on-dark"],
                            height: closeButtonDimensions.sm.iconSize,
                            width: closeButtonDimensions.sm.iconSize
                        }, [breakpoints.up(breakpoints.values.md)]: {
        ...
        MuiDialogTitle: {
            styleOverrides: {
                root: Object.assign(Object.assign({}, tokens.typography["headline-small"]), { padding: `${spacings["6"]} ${spacings["7"]} ${spacings["0"]}`, "& .DhigModal--logo": {
                        filter: filterColor,
                        height: spacings["6"],
                        width: "148px"
                    } })
