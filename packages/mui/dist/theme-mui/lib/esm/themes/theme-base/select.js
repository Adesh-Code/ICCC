export const makeSelectStyles = ({ primitives, tokens }) => ({
    MuiSelect: {
        styleOverrides: {
            root: Object.assign(Object.assign({ color: tokens.colors["ink-on-background"] }, tokens.typography["short-copy-medium"]), { backgroundColor: tokens.colors["field-fill"], "& em": {
