export const makeButtonStyles = ({ primitives, tokens }) => {
    const getButtonStyles = ({ size, variant }) => {
        const { button } = tokens;
        // Rewrite font size value to incorporate root font size factor
        const fontSize = size === "dense" ? primitives.fontSizes[2] : primitives.fontSizes[3];
        return Object.assign(Object.assign({}, button[variant][size].default), { alignItems: "flex-start", fontSize, "&:hover": Object.assign(Object.assign({}, button[variant][size].hover), { fontSize }), "&.Mui-disabled": Object.assign(Object.assign({}, button[variant][size].disabled), { fontSize }), "&:focus-visible": Object.assign(Object.assign({}, button[variant][size].focus), { fontSize }), "&:focus:active": Object.assign(Object.assign({}, button[variant][size].pressed), { fontSize }), "&:active": Object.assign(Object.assign({}, button[variant][size].pressed), { fontSize }) });
    };
            ...
            styleOverrides: {
                ...
                root: {
                    ...
                    "&[class*='MuiButton-link-button']": Object.assign(Object.assign({}, getButtonStyles({
                        size: "defaultSize",
                        variant: "link-button"
                    })), { "&:hover": Object.assign(Object.assign({ boxShadow: "none" }, tokens.textLink.hoverState), linkPseudoStateOverrides), "&:active, &:focus:active": Object.assign(Object.assign({ boxShadow: "none" }, tokens.textLink.pressedState), linkPseudoStateOverrides), "& [class*='MuiButton-startIcon']": {
                    ...
                    "&[class*='MuiButton-link-buttonSizeSmall']": Object.assign(Object.assign(Object.assign({}, getButtonStyles({
                        size: "dense",
                        variant: "link-button"
                    })), { lineHeight: primitives.lineHeights.default, "&:hover": Object.assign(Object.assign(Object.assign({ boxShadow: "none" }, tokens.textLink.hoverState), linkPseudoStateOverrides), linkDenseOverrides), "&:active, &:focus:active": Object.assign(Object.assign(Object.assign({ boxShadow: "none" }, tokens.textLink.pressedState), linkPseudoStateOverrides), linkDenseOverrides), "&:focus-visible": Object.assign(Object.assign({}, linkDenseOverrides), { lineHeight: primitives.lineHeights.default, "&:hover": {
