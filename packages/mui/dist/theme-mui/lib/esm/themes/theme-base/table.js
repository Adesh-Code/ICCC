export const makeTableStyles = ({ primitives, tokens }) => ({
    MuiTable: {
        styleOverrides: {
            root: {
    ...
    MuiTableSortLabel: {
        styleOverrides: {
            root: Object.assign(Object.assign({}, tokens.typography["headline-smaller"]), { color: tokens.colors["ink-on-background"], pointerEvents: "none", "&:hover, :focus": {
                    color: tokens.colors["ink-on-background"]
                }, "&:hover": {
                    "& svg[class*='MuiSvgIcon-root']": {
                        opacity: tokens.opacities.disabled
