export const makeButtonGroupStyles = ({ primitives, tokens }) => ({
    MuiButtonGroup: {
        defaultProps: {
        ...
        styleOverrides: {
            root: {
                '& [class*="MuiButton-root"]': Object.assign(Object.assign({ alignItems: "center" }, tokens.transitions["state-blur"]), { '& [class*="MuiSvgIcon-root"]': {
                        height: primitives.spacings["5"],
                        width: primitives.spacings["5"]
                    }, "&:hover, &:focus, &:active, &:focus-visible": Object.assign({ minWidth: "unset" }, tokens.transitions["state-activate"]), "&:first-of-type": {
