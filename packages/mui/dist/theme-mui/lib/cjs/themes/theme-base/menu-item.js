...
exports.makeMenuItemStyles = void 0;
var makeMenuItemStyles = exports.makeMenuItemStyles = function makeMenuItemStyles(_ref) {
  var primitives = _ref.primitives,
    tokens = _ref.tokens;
  return {
    MuiMenuItem: {
      styleOverrides: {
        root: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({
          boxShadow: "0px 0px 0px 2px ".concat(primitives.colors.detail.transparent, ", 0px 0px 0px 1px ").concat(primitives.colors.detail.transparent),
          ...
          padding: "".concat(primitives.spacings["2"], " ").concat(primitives.spacings["5"]),
          border: "2px solid ".concat(primitives.colors.detail.transparent)
        }), tokens.transitions["state-blur"]), {
          "&:hover, &:active, &:focus-visible": Object.assign({}, tokens.transitions["state-activate"]),
          "&:active": {
            backgroundColor: tokens.colors["pressed-fill-subtle"],
            boxShadow: "0px 0px 0px 2px ".concat(primitives.colors.detail.transparent)
          },
